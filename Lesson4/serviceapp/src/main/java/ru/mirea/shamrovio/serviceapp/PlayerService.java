...
public class PlayerService extends Service {
	...
	public void onCreate() {
		...
		NotificationCompat.Builder _builder = new NotificationCompat.Builder(this, CHANNEL_ID)
				...
				.setStyle(new NotificationCompat.BigTextStyle().bigText("Dorian Pinto"))
				.setContentText("Wanderers");
		int _importance = NotificationManager.IMPORTANCE_DEFAULT;
		NotificationChannel _channel = new NotificationChannel(CHANNEL_ID,
				"Student Shamrov Ilya Olegovich Notification", _importance);
