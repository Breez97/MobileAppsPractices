...
import ru.mirea.shamrovio.mireaproject.databinding.ActivityMapBinding;
...
public class MapActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
	...
	private final Point USER_LOC = new Point(55.798434, 37.393344);
	...
	private void addHomeMarker() {
		...
		homeTapListener = (mapObject, point) -> {
			AlertDialog.Builder builder = new AlertDialog.Builder(MapActivity.this)
					.setTitle("Дом")
					.setMessage("Москва, ул. Таллинская, д.6")
