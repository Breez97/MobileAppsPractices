package ru.mirea.shamrovio.mireaproject.ui.lesson6;
...
import ru.mirea.shamrovio.mireaproject.databinding.FragmentProfileBinding;
...
public class ProfileFragment extends Fragment {
	...
	private void setSharedPreferences() {
		binding.buttonSaveProfile.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putString("NICKNAME", binding.editTextNickname.getText().toString());
	...
	private void fillFields() {
		...
		binding.editTextNickname.setText(sharedPreferences.getString("NICKNAME", ""));
