package ru.mirea.shamrovio.mireaproject.ui.lesson4;
...
import ru.mirea.shamrovio.mireaproject.databinding.FragmentWorkerBinding;
...
public class WorkerFragment extends Fragment {
	...
	private long CalculateDelay(Calendar _currentDate) {
		// Разница между текущим временем и временем отправки уведомления
	...
	private void NotificationWorker(Calendar _currentDate) {
		...
		if(_title.isEmpty()) _title = "Без названия";
		if(_description.isEmpty()) _description = "Без описания";
